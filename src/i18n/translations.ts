...
export const ar: Translations = {
  ...
  growth: {
    ...
    stages: [
      ...
      },
      {
        ...
        line: "سمعة ومحتوى يميلان بالقرار لصالحكم.",
      },
      {
        n: "04",
        name: "الالتقاط",
      ...
      },
      {
        ...
        line: "كل استفسار يُجاب عليه، ليلاً أو نهارًا.",
      },
      {
        n: "06",
        name: "النمو",
  ...
  services: {
    ...
    items: [
      ...
      { name: "إعلانات الفيديو", line: "فيديوهات قصيرة توقف التمرير وتبيع النتيجة." },
      {
        ...
        line: "فيديوهات علامة تجارية احترافية بسرعة وتكلفة قابلة للتوسع.",
      },
      { name: "إعلانات ميتا", line: "صِلوا إلى الجمهور المناسب بحملات مصممة للتحويل." },
      {
  ...
  why: {
    ...
    p2: "الذكاء الاصطناعي هو مسرّعنا، لا منتجنا. يساعدنا على التحرك أسرع، والكتابة بدقة أكبر، وبناء أنظمة فعّالة — لكن كل قرار يتخذه إنسان يهتم فعلاً بعملكم.",
    cardHeading: "ما يهمنا هنا",
    imageAlt: "متحف المستقبل مضاءً ليلاً في دبي",
    items: [
      {
        title: "مقرنا في دبي",
        line: "استوديو نمو رقمي بوتيكي يعمل مع أعمال محلية طموحة في جميع أنحاء الإمارات.",
      },
      {
        title: "ما نبيعه",
      ...
      {
        title: "وعدنا",
        line: "لا عملاء وهميون، ولا شعارات مستعارة، ولا أرقام ملفّقة. كل شيء هنا صادق.",
      },
    ],
  },
  faq: {
  ...
  privacy: {
    ...
    disclaimer:
      "هذا ملخص بلغة مبسطة، وليس عقدًا قانونيًا. إذا كان لدى نشاطكم متطلبات امتثال محددة، تواصلوا معنا وسنكون سعداء بالمساعدة.",
  },
  terms: {
    eyebrow: "الشروط",
